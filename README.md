...
- The **DOM** is basically the document object model where it is an object of the whole document. where it shows you what type of properties and values the document has.

2. What is an event?

- An event is something that always dynamic activity to accure, any time a user clicks on a document that would be considered an event.

3. What is an event listener?

- an event listener is basically a type of event that always the document to listen for on the document, it listens to scroll clicks mouse hover etc. If that accurs on the document then a certain program or function will accure


4. Why would we convert a NodeList into an Array?

- We would conver a nodlist into an array so then we can have access to array method, becuse nodelist are limited an not considered arrays

5. What is a component?

- a component is a group of code that return some html code and functionality towards that code.
